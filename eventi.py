        ...
        try:
            ...
            if iframe and iframe.get('src'):
                ...
                if 'server_key' in server_key_data:
                    ...
                    stream_url = f"https://{server_key}new.koskoros.ru/{server_key}/premium{channel_id}/mono.m3u8"
...
def generate_m3u8_from_json(json_data):
    m3u8_content = '#EXTM3U tvg-url="https://raw.githubusercontent.com/realbestia/itatv/refs/heads/main/eventi.xml"\n'
