...
def get_tvg_id_and_icon_from_config(tvg_name, config_data):
    """Trova il miglior tvg-id e tvg-icon dalla configurazione JSON"""
    best_match = None
    best_score = 0
    best_icon = None
    ...
    for channel in config_data:
        epg_channel_name = channel.get("tvg-name")
...
def get_config_from_url(config_url):
    """Scarica la configurazione JSON"""
    try:
